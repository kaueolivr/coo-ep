...
public interface Personagem {
	...
	public int verificaEstado(long tempoAtual, long delta); // Verifica o estado do personagem e invoca os métodos a seguir, dependendo do estado
	public void fimExplosao(long tempo); // Verifica se a explosão foi finalizada, atualizando o estado em caso positivo - MANTER?
	public void verificaSaidaDaTela(); // Verifica se saiu da tela (deixando inativo, no caso dos inimigos, ou travando em uma posição, no caso do jogador) - MANTER?
